...
type ExtractedSignals struct {
	...
	// SkillsUsed lists human-authored skills the developer invoked — a context
	// covariate, never scored. SkillAssisted flags the session so the leaderboard
	// can stratify it: skill scaffolding confounds model attribution.
